...
//        //Retrasar el tiempo de actuallizacion del ElCodigo para el autocompletar
...
//        public DetalleDTO LosDetalles { get; set; }
...
//        private List<Cuenta> CuentasFiltradas { get; set; } = new List<Cuenta>();
